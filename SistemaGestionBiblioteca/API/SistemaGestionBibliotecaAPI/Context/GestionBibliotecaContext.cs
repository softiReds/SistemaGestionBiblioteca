...
using SistemaGestionBibliotecaAPI.Models;

namespace SistemaGestionBibliotecaAPI.Context
{
    public class GestionBibliotecaContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Reserva>(reserva =>
            {
                ...
                reserva.HasOne(p => p.EstadoReserva).WithMany(p => p.Reservas).HasForeignKey(p => p.EstadoReservaId);
            ...
            {
                tipoUsuario.ToTable("TipoUsaurio");
            ...
            builder.Entity<Usuario>(usuario =>
            {
                ...
                usuario.HasOne(p => p.TipoUsuario).WithMany(p => p.Usuarios).HasForeignKey(p => p.TipoUsuarioId);
